...
namespace CarRentalApplication.Controllers
{
    public class MaintenanceController : Controller
    {
        ...
        public async Task<IActionResult> History(int vehicleId)
        {
            ...
            try
            {
                var response = await client.GetAsync($"maintenance-service/api/maintenance/vehicles/{vehicleId}/repairs");
        ...
        public async Task<IActionResult> Usage()
        {
            ...
            try
            {
                var response = await client.GetAsync("maintenance-service/api/maintenance/usage");
